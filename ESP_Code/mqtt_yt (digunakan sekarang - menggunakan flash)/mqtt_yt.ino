...
// WiFi
#define WLAN_SSID "Hamzah" // isi dengan nama Wi-Fi
#define WLAN_PASS "11333355555577777777b@ssPu$ing" // isi dengan password Wi-Fi

// #define WLAN_SSID "" // isi dengan nama Wi-Fi
// #define WLAN_PASS "bintang8kali" // isi dengan password Wi-Fi
